...
class ensemble_linear_predictor_mock : public ensemble_linear_predictor {
   public:
    ensemble_linear_predictor_mock(
        ...
        : ensemble_linear_predictor( query_observations, configs,
                                     ( 1 << 16 ) ) {}
